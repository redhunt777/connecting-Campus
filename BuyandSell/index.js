...
window.onload = function() {
    ...
    class MEME_CHAT{
      ...
      create_title(){
        ...
        title.textContent = 'Buy And Sell'
      ...
      send_message(message){
        ...
        db.ref('buyandsell/').once('value', function(message_object) {
          // This index is mortant. It will help organize the chat in order
          var index = parseFloat(message_object.numChildren()) + 1
          db.ref('buyandsell/' + `message_${index}`).set({
      ...
      refresh_chat(){
        ...
        db.ref('buyandsell/').on('value', function(messages_object) {
