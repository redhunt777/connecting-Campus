...
window.onload = function() {
    ...
    class MEME_CHAT{
      ...
      send_message(message){
        ...
        db.ref('carpooling/').once('value', function(message_object) {
          // This index is mortant. It will help organize the chat in order
          var index = parseFloat(message_object.numChildren()) + 1
          db.ref('carpooling/' + `message_${index}`).set({
      ...
      refresh_chat(){
        ...
        db.ref('carpooling/').on('value', function(messages_object) {
