...
window.onload = function() {
    ...
    class MEME_CHAT{
      ...
      create_title(){
        ...
        title.textContent = 'Lost And Found'
      ...
      create_join_form() {
        ...
        // Instead of creating an input field, set the username directly
        var predefinedUsername = displayName;
        parent.save_name(predefinedUsername);
      ...
      create_chat(){
        ...
        chat_input_send.textContent = 'Send'; // Set the text content to 'Send'
        document.body.appendChild(chat_input_send);
        ...
        chat_logout.textContent = "Return to Home page"
      ...
      send_message(message){
        ...
        db.ref('chatslostandfound/').once('value', function(message_object) {
          // This index is mortant. It will help organize the chat in order
          var index = parseFloat(message_object.numChildren()) + 1
          db.ref('chatslostandfound/' + `message_${index}`).set({
      ...
      refresh_chat(){
        ...
        db.ref('chatslostandfound/').on('value', function(messages_object) {
